...
var metricAllDataTypes []*otlpmetrics.ResourceMetrics = []*otlpmetrics.ResourceMetrics{
	{
...
var expectedMetricAllDataTypes []*otlpmetrics.ResourceMetrics = []*otlpmetrics.ResourceMetrics{
	{
		Resource: &v1.Resource{
			Attributes:             []*v11.KeyValue{},
			DroppedAttributesCount: 0,
